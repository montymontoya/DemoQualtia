...
namespace Pixyz.Commons.Extensions
{
    public static class SceneExtensions
    {
        ...
        /// <returns></returns>
        public static GameObject GetHighestAncestor(this IList<GameObject> gameObjects) {
        ...
        /// <summary>
        /// Returns the highest ancestors (hierarchically) of a list of GameObjects 
        /// </summary>
        /// <param name="gameObjects"></param>
        /// <returns></returns>
        public static IList<GameObject> GetHighestAncestors(this IList<GameObject> gameObjects)
        {
            HashSet<GameObject> selectedGameObjects = new HashSet<GameObject>(gameObjects);
            ...
            return highestSelectedAncestors.ToList();
        }
