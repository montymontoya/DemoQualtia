...
namespace Pixyz.Plugin4Unity.Core
{
    internal class PreferencesProvider : SettingsProvider
    {
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            GUILayout.Space(5);
            Preferences.CustomImportMaxSag = EditorGUILayout.FloatField("Custom Tesselation: Max Sag", Preferences.CustomImportMaxSag);
            Preferences.CustomImportSagRatio = EditorGUILayout.FloatField("Custom Tesselation: Sag Ratio", Preferences.CustomImportSagRatio);
            GUILayout.Space(5);
    ...
    public static class Preferences
    {
        ...
        public static float CustomImportSagRatio
        {
            get
            {
                if(!EditorPrefs.HasKey("Pixyz_CustomImportSagRatio"))
                    EditorPrefs.SetFloat("Pixyz_CustomImportSagRatio", 0.0001f);
                return EditorPrefs.GetFloat("Pixyz_CustomImportSagRatio");
            }
            set
            {
                EditorPrefs.SetFloat("Pixyz_CustomImportSagRatio", value);
            }
        }

        public static float CustomImportMaxSag
        {
            get
            {
                if (!EditorPrefs.HasKey("Pixyz_CustomImportMaxSag"))
                    EditorPrefs.SetFloat("Pixyz_CustomImportMaxSag", 0.1f);
                return EditorPrefs.GetFloat("Pixyz_CustomImportMaxSag");
            }
            set
            {
                EditorPrefs.SetFloat("Pixyz_CustomImportMaxSag", value);
            }
        }
        ...
        public static string DefaultImportSettingsLocation
        {
            get
            {
                return "Assets/Pixyz/Editor";
            }
        }
        public static string ToolboxActionsLocation
        {
            get
            {
                return "Assets/Pixyz/Editor/Actions";
            }
        }
        ...
        public static bool IncludeForRuntimeWindows
        {
            get
            {
                return EditorPrefs.GetBool("Pixyz_IncludeForRuntimeWindows", Pixyz.Core.Native.NativeInterface.TokenValid("UnityRuntime"));
            }
