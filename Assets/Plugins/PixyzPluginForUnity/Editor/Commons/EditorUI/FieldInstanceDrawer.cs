                    ...
                    if (fieldInstance.unfolded)
                    {
                        for (int f = 0; f < fields.Length; f++)
                        {
                            ...
                            if (attributes.Count() > 0)
                            {
                                ...
                                {
                                    if (attributes.First().ConstructorArguments[3].ToString().Trim(new Char[] { '"' }) != String.Empty)
                                        fieldName = attributes.First().ConstructorArguments[3].ToString().Trim(new Char[] { '"' }); //Getting name if set
                                    fieldTooltip = attributes.First().ConstructorArguments[2].ToString().Trim(new Char[] { '"' }); //Getting tooltip
                                }
                            }
                            if (drawParameter)
                            {
