...
namespace Pixyz.Commons.UI.Editor
{
    ...
    public sealed class FieldInstance {
        ...
        public readonly bool collapsable;
        ...
        public FieldInstance(FieldInfo fieldInfo, object reference, string visibilityCheck = null, string enablingCheck = null, string tooltip = null, string displayName = null, bool collapsable=false) {
        ...
        public void serializeData(ref Dictionary<string, string> pairs) {
            this.Serialize(ref pairs, fieldInfo.Name, value, type);
        }
        ...
        public void deserializeData(Dictionary<string, string> pairs) {
            value = this.Unserialize(ref pairs, fieldInfo.Name, type);
        }
    }
}
