...
namespace Pixyz.Commons.UI.Editor
{
    ...
    public abstract class ActionBase {
        ...
        /// </summary>
        public virtual bool updateStats => true;
        ...
        public virtual void initialize() {
            ...
            foreach (FieldInfo fieldInfo in GetType().GetFields()) {
                ...
                if (fieldInfo.HasAttribute(out userParameter)) {
                    fieldInstancesList.Add(new FieldInstance(fieldInfo, this, userParameter.visibilityCheck, userParameter.enablingCheck, userParameter.tooltip, userParameter.displayName, userParameter.collapsable));
                }
            }
