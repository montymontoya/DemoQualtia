...
namespace Pixyz.RuleEngine.Editor
{
    public class SwitchMaterials : ActionInOut<IList<GameObject>, IList<GameObject>> {
        ...
        public void fillFromCSV() {
            ...
            string csvFile = (FilePath)Pixyz.Plugin4Unity.ReferencableEditorUtils.SelectFile(new string[] { "CSV File", "csv" });
            ...
            for (int i = 0; i < lines.Length; i++) {
                ...
                materialRemplacements.Add(new MaterialRemplacement { materialName = splitLine[0].Trim(), unityMaterial = (splitLine.Length < 2) ? null : Resources.Load<UnityEngine.Material>(splitLine[1].Trim()) });
            }
        ...
        public override IList<GameObject> run(IList<GameObject> input) {
            ...
            for (int i = 0; i < input.Count; i++) {
                ...
                if (!meshRenderer)
                    continue;
                UnityEngine.Material[] meshMaterials = meshRenderer.sharedMaterials;
                bool modified = false;
