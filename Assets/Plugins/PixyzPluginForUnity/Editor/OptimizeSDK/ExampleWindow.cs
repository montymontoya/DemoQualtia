...
#pragma warning restore CS4014
        ...
        private void Process()
        {
            try
            {
                uint scene = Scene.Native.NativeInterface.CreateSceneFromMeshes(_context.pixyzMeshes, _context.pixyzMatrices, true);
                ...
                Algo.Native.NativeInterface.RepairMesh(occurrenceList, 0.1f, true, false);
                ...
                options._type = Algo.Native.DecimateOptionsSelector.Type.TRIANGLECOUNT;
                options.triangleCount = 15000;
                Algo.Native.NativeInterface.DecimateTarget(occurrenceList, options, Algo.Native.UVImportanceEnum.PreserveSeamsAndReduceDeformation, true, options.triangleCount);
        ...
        private void Completed()
        {
            ...
            foreach (UnityEngine.Material mat in _context.GeneratedMaterials)
            {
