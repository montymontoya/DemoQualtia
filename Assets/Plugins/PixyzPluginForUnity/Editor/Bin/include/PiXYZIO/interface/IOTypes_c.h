...
PXZ_EXPORTED void IO_Format_init(IO_Format * str);
PXZ_EXPORTED void IO_Format_free(IO_Format * str);
typedef struct {
   size_t size;
   IO_Format * list;
} IO_FormatList;

PXZ_EXPORTED void IO_FormatList_init(IO_FormatList * list, size_t size = 0);
PXZ_EXPORTED void IO_FormatList_free(IO_FormatList * list);
