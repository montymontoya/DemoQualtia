...
struct StylizedLine {
   ...
   //! External ID.
   CoreI::Ident externalId;
   StylizedLine(CoreI::IntList _lines = CoreI::IntList(), CoreI::Double _width = 0, StyleType _type = StyleType::NORMAL, CoreI::Int _pattern = 0, CoreI::ColorAlpha _color = CoreI::ColorAlpha(), CoreI::Ident _externalId = 0) : lines(_lines), width(_width), type(_type), pattern(_pattern), color(_color), externalId(_externalId) {}
};
