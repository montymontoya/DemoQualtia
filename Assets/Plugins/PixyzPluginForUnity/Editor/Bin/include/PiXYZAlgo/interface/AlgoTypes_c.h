...
typedef enum {
 Algo_ConvexityConstraint_REMOVE_CONVEX_ONLY = 0,
 Algo_ConvexityConstraint_REMOVE_CONCAVE_ONLY = 1,
 Algo_ConvexityConstraint_REMOVE_BOTH = 2,
} Algo_ConvexityConstraint;
...
typedef enum {
 Algo_SmartHiddenType_All = 0,
 Algo_SmartHiddenType_OnlyOuter = 1,
 Algo_SmartHiddenType_OnlyInners = 2,
} Algo_SmartHiddenType;

typedef enum {
 Algo_SmartOrientStrategy_VisibilityByConnected = 0,
 Algo_SmartOrientStrategy_VisibilityByPolygon = 1,
} Algo_SmartOrientStrategy;
