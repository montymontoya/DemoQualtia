...
namespace Pixyz.Toolbox.Editor
{
    ...
    {
        private const int SIZE_INIT = 1024;
        ...
        private Dictionary<UnityEngine.Material, int> _materials = new Dictionary<UnityEngine.Material, int>();

        private string name;

        private bool _needTangentCompute = false;

        public int vertexCount => _vertices.Count;

        public void add(Mesh mesh, UnityEngine.Material[] materials, Matrix4x4 matrix)
        {
        ...
        public int getSubmeshFromMaterial(UnityEngine.Material material)
        {
        ...
        public UnityEngine.Material[] sharedMaterials => _materials.Keys.ToArray();
        ...
        public Mesh getMesh()
        {
            ...
            if (_needTangentCompute && hasOnlyTriangles)
