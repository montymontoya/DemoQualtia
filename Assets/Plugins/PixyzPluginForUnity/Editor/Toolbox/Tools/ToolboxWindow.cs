...
namespace Pixyz.Toolbox.Editor
{
    public class ToolboxWindow : EditorWindow {
        ...
        void OnEnable() {
            ...
            Selection.selectionChanged += ()=>{  statsBeforeProcess = action.updateStats || !_hasProcessed ? null : statsBeforeProcess; action.onSelectionChanged(getSelectedGameObjects()); Repaint(); _hasProcessed = action.updateStats || !_hasProcessed ? false : _hasProcessed; };
        }
        ...
        private StatsReport getStats(IList<GameObject> gameObjects) {
            ...
            var materials = new HashSet<UnityEngine.Material>();
            ...
            for (int i = 0; i < gameObjects.Count; i++) {
                ...
                gameObjects[i].GetMeshData(out Renderer renderer, out Mesh mesh, out UnityEngine.Material[] lmaterials);
